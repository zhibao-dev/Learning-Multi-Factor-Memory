...
\caption{\textbf{Blind vs.\ oracle gold retention} (keep $30\%$; $74$-case
LongMemEval-S pilot; $20$ resampled splits, mean $\pm 1$ std). Under the
\emph{oracle} goal anchor (cosine to the held-out question), similarity
...
value retains $0.81$. Recency has no oracle variant.}
\label{fig:blind}
\end{figure}
