...
\item \textbf{Empirical results} on a real LongMemEval-S pilot: in the
blind regime, learned multi-factor value retains $0.811\pm0.047$ of gold
evidence versus $0.634$ (uniform), $0.541$ (best single factor,
reliability), and $0.380$ (recency), winning on every one of $20$
resampled splits, with interpretable learned weights
(\cref{sec:exp:blind}); a synthetic confound study validates the learner
(\cref{sec:exp:synth}).
