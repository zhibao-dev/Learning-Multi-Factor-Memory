...
The single scalar $V(m)$ drives all three memory operations, replacing
the separate, hand-tuned rules of prior systems.
...
(\cref{sec:exp:blind}), we rank candidates directly by $V(m)$ under the
retrieval-time goal anchor and report retention of the gold set.
