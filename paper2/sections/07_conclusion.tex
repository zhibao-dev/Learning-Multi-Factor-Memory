...
governs all three operations. On a real LongMemEval-S pilot, a learned
multi-factor value retains $0.811\pm0.047$ of gold evidence in the
realistic blind-forgetting regime, versus $0.634$ for uniform weighting,
$0.541$ for the best single factor, and $0.380$ for recency --- winning
on every resampled split, with interpretable weights that recover the
workload's true signal. We also showed why this advantage is invisible to a query-defined
