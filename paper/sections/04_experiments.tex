...
\paragraph{Design.}
We replace the v0.1 bag-of-tokens embedder with a sentence-transformers
encoder (\texttt{all-MiniLM-L6-v2}, 384-dim) \cite{reimers2019sbert}.
...
the human depth-of-processing prediction:
\[
\text{structural}\,(0.518)
\;<\; \text{phonemic}\,(0.500)
\;<\; \text{semantic}\,(0.582)
\;<\; \text{self\_ref}\,(0.623).
\]
