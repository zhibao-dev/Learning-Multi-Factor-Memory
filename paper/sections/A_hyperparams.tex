...
cd BorgeAgent && git checkout v0.5-submit-after-minor
...
Total wall-clock for the four CPU experiments is under thirty seconds on a
...
\begin{center}
\small
\captionof{table}{E2 log-scale OLS sanity check.}
\label{tab:e2log}
\begin{tabular}{lrr}
\toprule
