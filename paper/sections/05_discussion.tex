...
The retrieval-side
$w_s\,\cos(\muself^{\text{enc},i}, \muself^{\text{now}})$ term then
biases recall toward content whose self prior at encoding time matched
the agent's current self prior --- a state-dependent retrieval
mechanism in the strict encoding-specificity tradition
\cite{tulving1973encodingspec}.
