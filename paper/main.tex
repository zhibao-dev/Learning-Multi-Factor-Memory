...
cognitive-layer substrate and run three controlled CPU experiments:
...
We name five scope boundaries (\cref{sec:limitations}) and a corresponding
validation roadmap; the present work establishes the mechanism, not the
quantitative human-data fit. The substrate is open-source and the
experiments complete in seconds on a single CPU.
\end{abstract}
